...
const Navbar = () => {
    ...
    return (
        ...
        <div className="bg-lightBlue-900">
            ...
            <div className="max-w-7xl mx-auto flex flex-row justify-between items-center p-4">
                <div>
                    <Link href="/">
                        <a className="flex items-center flex-row text-xl md:text-3xl font-semibold text-white" >
                            <img className="h-8 md:h-12 mr-4" src="/img/eagle-logo-blue.png" alt="Eagle Logo"/>
                            Eagle Experts
                        </a>
                    </Link>
                </div>
                ...
                <div className="block md:hidden pt-2">
                    <button onClick={() => setMenuVisibility(true)} className="focus:outline-none">
        ...
        <div className={`${isMenuVisible ? 'fixed' : 'hidden' } top-0 left-0 z-30 w-screen h-screen bg-black bg-opacity-80 flex flex-row `}>
            ...
            <div className="flex-1 text-right" onClick={() => setMenuVisibility(false)}>
                <button onClick={() => setMenuVisibility(false)} className="focus:outline-none">
                    ...
                    <svg viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" class="text-white"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </div>
                </button>
            </div>
        </div>
